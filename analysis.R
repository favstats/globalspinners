...
linkie <- function(.x, cntry) {
  download.file(glue::glue("https://github.com/favstats/meta_ad_reports/releases/download/{cntry}-last_30_days/{.x}.rds"), destfile = "data.rds", quiet = T)
